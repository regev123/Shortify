...
import com.shortify.create.controller.CreateUrlController;
...
class CreateUrlControllerTest {
    ...
    @Configuration
    @ComponentScan(
            basePackages = {"com.shortify.create.controller"},
            excludeFilters = @ComponentScan.Filter(
                    type = FilterType.ASSIGNABLE_TYPE,
                    classes = com.shortify.create.CreateServiceApplication.class
            )
    )
    ...
    void createShortUrl_ServiceFailure_ReturnsInternalServerError() throws Exception {
        ...
        CreateUrlResult failureResult = CreateUrlResult.builder()
                .success(false)
                .errorCode(com.shortify.constants.ErrorCode.INTERNAL_SERVER_ERROR)
                .build();
